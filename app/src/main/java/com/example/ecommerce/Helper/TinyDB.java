...
public class TinyDB {
    ...
    public ArrayList<populerDomain> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<populerDomain> playerList =  new ArrayList<populerDomain>();

        for(String jObjString : objStrings){
            populerDomain player  = gson.fromJson(jObjString,  populerDomain.class);
    ...
    public void putListObject(String key, ArrayList<populerDomain> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(populerDomain player: playerList){
